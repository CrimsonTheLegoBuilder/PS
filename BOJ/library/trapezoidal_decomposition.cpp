...
struct Proj {
	ll s, e; int i;
	Proj(ll s_ = 0, ll e_ = 0, int i_ = -1) : s(s_), e(e_), i(i_) {}
};
ll count(const Polygon& H, const int& s, const int& e, const int& n) {
	...
	//	std::cout << "DEBUG::\n";
	//	std::cout << "	s::" << s << " e:: " << e << "\n";
	//	std::cout << "	H[s]::" << H[s] << " H[e]:: " << H[e] << "\n";
	//	std::cout << "P:: DEBUG::\n";
	//	std::cout << "	P::\n";
	//	for (const Pos& p : P) std::cout << "	idx:: " << p.i << " :: " << p << "\n";
	//	std::cout << "	P::\n";
	//	std::cout << "P:: DEBUG::\n";
	//#endif
#ifdef DEBUG
	...
	//	std::cout << "SEG:: DEBUG::\n";
	//	std::cout << "	SEG::\n";
	//	for (int i = 0; i < sz; i++) std::cout << "	idx:: " << i << " s:: " << seg[i].s << " e:: " << seg[i].e << "\n";
	//	std::cout << "	SEG::\n";
	//	std::cout << "SEG:: DEBUG::\n";
	//	std::cout << "DEBUG::\n";
	//#endif
...
void solve() {
	...
	Polygon tmp;
	for (int i = 0; i < N; i++) if (V[i]) tmp.push_back(P[i]);
	P = tmp; N = P.size();
	...
	for (int _ = 0; _ < 2; _++) {
		...
		for (int i = 0; i < sz; i++) {
			//#ifdef DEBUG
			//			std::cout << "DEBUG::\n";
			//			std::cout << "	H[i].i           :: " << H[i].i << "\n";
			//			std::cout << "	H[i]             :: " << H[i] << "\n";
			//			std::cout << "	(H[i].i + 1) % N :: " << (H[i].i + 1) % N << "\n";
			//			std::cout << "	H[(i + 1) % sz].i:: " << H[(i + 1) % sz].i << "\n";
			//			std::cout << "DEBUG::\n";
			//#endif
